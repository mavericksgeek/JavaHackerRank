...
The second column contains the integer, expressed in exactly  digits; if the original input has less 
...
is the 16th character, and each integer that was less than  digits now has 3 leading zeroes.
*/
